  ...
  return (
    <div ref={wrapRef} className="relative">
      <button
        ...
        className="btn btn-primary inline-flex max-w-[200px] items-center gap-1.5"
      >
        {student ? (
          <>
            <span
      ...
      {open ? (
        <div
          ...
          className="absolute right-0 top-full z-50 mt-1 w-64 border border-hair bg-white shadow-chrome"
        >
          {student ? (
